...
export function createPatchFunction(backend) {
  ...
  function createElm(
    ...
    if (createComponent(vnode, insertedVnodeQueue, parentElm, refElm)) { /// 如果是组件测创建组件
      return
    }
    ...
    if (isDef(tag)) {
      ...
      vnode.elm = vnode.ns
        ? nodeOps.createElementNS(vnode.ns, tag) /// 命名空间的标签创建
